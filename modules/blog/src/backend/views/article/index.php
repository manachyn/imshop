...
/* @var $searchModel im\blog\models\ArticleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Module::t('article', 'Articles');
$this->params['subtitle'] = Module::t('article', 'Articles list');
